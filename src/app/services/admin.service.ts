...
export class AdminService {
  ...
  constructor(private httpClient: HttpClient) {
    console.log("From CTOR of Admin.service.ts");
   }
  ...
  public getACustomer(id: number): Observable<customer>{
    alert(id);
    return this.httpClient.get<customer>("http://localhost:8080/ClickCouponsSystem/rest/sec/adminService/get-one-customer/" + id);
//    const url=`${'http://localhost:8080/ClickCouponsSystem/rest/sec/adminService/get-one-customer'}?id=${id}`;
